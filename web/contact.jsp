            ...
            <div class="container">
                <div class="contact-grids">
                    ...
                    <div class="col-md-4 contact-grid text-center animated wow slideInUp" data-wow-delay=".5s">
                        <div class="contact-grid2">
                            ...
                            <h4>Call Us</h4>
                            <p>+0925489239<span>+1273 748 730</span></p>
                        </div>
                    </div>
                    <div class="col-md-4 contact-grid text-center animated wow slideInRight" data-wow-delay=".5s">
                        <div class="contact-grid3">
                            ...
                            <h4>Email</h4>
                            <p><a href="mailto:info@example.com">datthps06159@fpt.edu.vn</a><span><a href="mailto:info@example.com">trahoangdat1998@gmail.com</a></span></p>
                        </div>
                    </div>
                ...
                <form action="ControllerMail">
                    <div class="contact-form2">
                        <input type="text" value="" name="txtNam" required=""/>
                                <input type="email" value="" name="Mail" required=""/>
                                <textarea type="text" name="Mess" placeholder="Message" required=""></textarea>
